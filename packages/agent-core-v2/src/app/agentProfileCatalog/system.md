...
- Make new code read like the code around it: match the surrounding file's naming conventions rather than importing your own defaults. Prefer the project's existing patterns over inventing a new style.
